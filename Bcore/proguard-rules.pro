...
-assumenosideeffects class top.niunaijun.blackbox.BlackBoxCore {
...
-keep class top.niunaijun.blackbox.jnihook.jni.JniHook {
    *;
}

# Native offset field specifically preserve karo
-keepclassmembers class top.niunaijun.blackbox.jnihook.jni.JniHook {
...
-keep class top.niunaijun.blackbox.core.VNative {
    *;
}
...
-keepclassmembers class top.niunaijun.blackbox.BlackBoxCore {
    public <init>(...);
    public static top.niunaijun.blackbox.BlackBoxCore get();
    ...
    public top.niunaijun.blackbox.entity.AppConfig getAppConfig();
    ...
    # Context methods
    public void doAttachBaseContext(android.content.Context, top.niunaijun.blackbox.app.configuration.ClientConfiguration);
    ...
    # Manager getters
    public static top.niunaijun.blackbox.fake.frameworks.BJobManager getBJobManager();
    public static top.niunaijun.blackbox.fake.frameworks.BPackageManager getBPackageManager();
    public static top.niunaijun.blackbox.fake.frameworks.BActivityManager getBActivityManager();
    public static top.niunaijun.blackbox.fake.frameworks.BStorageManager getBStorageManager();
    ...
    public top.niunaijun.blackbox.entity.pm.InstallResult installPackageAsUser(java.lang.String, int);
    public top.niunaijun.blackbox.entity.pm.InstallResult installPackageAsUser(java.io.File, int);
    public top.niunaijun.blackbox.entity.pm.InstallResult installPackageAsUser(android.net.Uri, int);
    
    # Xposed methods
    public top.niunaijun.blackbox.entity.pm.InstallResult installXPModule(java.io.File);
    public top.niunaijun.blackbox.entity.pm.InstallResult installXPModule(android.net.Uri);
    public top.niunaijun.blackbox.entity.pm.InstallResult installXPModule(java.lang.String);
    ...
    public top.niunaijun.blackbox.core.system.user.BUserInfo createUser(int);
    public void deleteUser(int);
    
    # Lifecycle callbacks
    public java.util.List getAppLifecycleCallbacks();
    public void removeAppLifecycleCallback(top.niunaijun.blackbox.app.configuration.AppLifecycleCallback);
    public void addAppLifecycleCallback(top.niunaijun.blackbox.app.configuration.AppLifecycleCallback);
    
    # GMS methods
    public boolean isSupportGms();
    public boolean isInstallGms(int);
    public top.niunaijun.blackbox.entity.pm.InstallResult installGms(int);
...
-keep class top.niunaijun.blackbox.BlackBoxCore$ProcessType {
    *;
}
...
-keep class top.niunaijun.blackbox.fake.service.*Proxy
-keep class top.niunaijun.blackbox.fake.service.*Proxy$*

# 3. Keep Critical Methods in Main Proxy Classes (Overrides from ClassInvocationStub)
-keepclassmembers class top.niunaijun.blackbox.fake.service.*Proxy {
    public <init>(...);
...
-keepclassmembers class top.niunaijun.blackbox.proxy.ProxyManifest {
...
-keep class top.niunaijun.blackbox.core.system.** { *; }
-keep class top.niunaijun.blackbox.fake.delegate.** { *; }
-keep class top.niunaijun.blackbox.fake.frameworks.** { *; }
...
-keep class top.niunaijun.blackbox.core.env.BEnvironment { *; }
-keep class top.niunaijun.blackbox.utils.FileUtils { *; }
-keep class top.niunaijun.blackbox.core.HostApp { *; }
-keep class top.niunaijun.blackbox.app.LauncherActivity { *; }
-keep class top.niunaijun.blackbox.app.configuration.AppLifecycleCallback { *; }
-keep class top.niunaijun.blackbox.app.configuration.ClientConfiguration { *; }
...
-keep class top.niunaijun.blackbox.entity.pm.InstallResult { *; }
